...
// If donor already logged in, redirect
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($check->num_rows > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO donors (name, email, password, blood_group, phone, address, created_at) VALUES (?, ?, ?, ?, ?, ?, NOW())");
...
<div class="container mt-5" style="max-width:600px;">
    <h2 class="text-center text-danger"><i class="fas fa-user-plus"></i> Donor Registration</h2>
    <p class="text-center text-muted">Join as a donor and save lives!</p>
    ...
    <form method="POST" class="border p-4 rounded bg-light shadow">
        ...
        <button type="submit" class="btn btn-danger w-100"><i class="fas fa-save"></i> Register</button>
    </form>
